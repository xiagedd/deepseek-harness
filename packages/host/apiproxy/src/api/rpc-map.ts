...
export interface RpcMethodMap {
  ...
  'host.searchEntries': HostApi['searchEntries']
  'host.mkdir': HostApi['mkdir']
  'host.rename': HostApi['rename']
  'host.delete': HostApi['delete']
  'host.copy': HostApi['copy']
  'host.writeText': HostApi['writeText']
  'host.readText': HostApi['readText']
  'host.openPath': HostApi['openPath']
  'host.revealPath': HostApi['revealPath']
  'host.restartWeb': HostApi['restartWeb']
