...
| [`web-local-tools/`](web-local-tools/README.md) | Optional Web overlay: Settings MCP/Skills/Rules/Ignore + Host inventories; mutually exclusive with in-box web-app rows of the same ids | — (patch only) |
