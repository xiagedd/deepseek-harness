...
export const zh = {
  ...
  'chip.remove': '移除引用 {name}',
  'drop.pathUnavailable': '无法获取本地路径，未插入引用',
  'drop.outsideWorkspace': '文件不在当前工作区内，未插入引用',
...
export const en = {
  ...
  'chip.remove': 'Remove reference {name}',
  'drop.pathUnavailable': 'No local path available; the file was not inserted as a reference',
  'drop.outsideWorkspace': 'The file is outside the current workspace and was not inserted as a reference',
