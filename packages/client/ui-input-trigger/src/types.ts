 ...
 * no runtime code. Sources (ui-commands / ui-skill / ui-subagent /
 * ui-workspace-file) and the conversation input layer import from here;
 * changes require main-thread arbitration.
 *
