...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-explorer': { kind: 'none', reason: 'Browser-side UI plugin layer; registers nothing model-facing.' },
  ...
  'packages/bundle/web-local-tools': { kind: 'indirect', reason: 'The overlay is a patch-list carrier; each inserted Settings inventory row\'s package owns its model-facing behavior.' },
